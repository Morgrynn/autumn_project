...
const storage = {
  ...
  add: function (storage, callback) {
    return db.query(
      'insert into storage_table(storage_name, capacity, price_pergb, type, cache, form_factor, interface, rating, price, image) values($1,$2,$3,$4,$5,$6,$7,$8,$8,$9,$10)',
      [
  ...
  update: function (id, storage, callback) {
    return db.query(
      'update storage_table set storage_name=$1, capacity=$2, price_pergb=$3, type=$4, cache=$5, form_factor=$6, interface=$7, rating=$8, price=$9 image=$10 where id=$11',
      [
        storage.storage_name,
        storage.capacity,
        storage.price_pergb,
